  ...
  return (
    ...
    <Header/>
      ...
      <div className="tracking flex w-full h-6  mt-2 ">
                <span className='flex items-center gap-2 ml-4 text-sm font-semibold tracking-wider'><RxDotFilled className='font-bold text-black text-md' /> HOME <FaArrowRightLong className="text-gray-950 text-sm" /> MAP </span>
            </div>
