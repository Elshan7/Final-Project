...
const Section2 = () => {
  ...
  return (
    <section id="sct2" className="sct2 w-full h-[665px] flex justify-center items-end ">
      <div   className="sct2-container w-[80%] h-[545px]  flex justify-end overflow-hidden ">
        <div data-aos-duration="2000" data-aos="zoom-in"  className="sct2-rightcontainer w-[50%] h-[545px] ">
          <h2 className=' sct2-h2 text-[#151515] font-bold duration-700  font-["Montserrat"] mb-3 ml-5 '>
            WHY CHOOSE US
          </h2>
...

            {
              ...
              <div className="sct2-subbox w-[482px] h-[104px] flex justify-center items-center">
                <div  className="left-icon w-[90px] h-[84px] ">
                  <img className="lefticon-img w-[85px] h-[85px]" src={item.image} alt="" />

                </div>
                <div className="right-subtext w-[352px] h-[84px]  flex flex-col justify-between items-center ">
                  <h4 className='sct2-h4 text-[20px] text-[#151515] font-["Montserrat"] uppercase font-[700]'>
                    {item.title}
                  </h4>
                  <p className='sct2-desc text-[15px] font-[400] w-[323px] leading-normal text-[#777777] font-["Lato"] text-center tracking-wide'>
                    {item.description}
                  </p>
                </div>
              </div>
