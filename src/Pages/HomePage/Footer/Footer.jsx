        ...
        <div className="footer-up w-full h-[402px] flex justify-center items-center">
            ...
            <div className="footer-up-container w-[80%] h-[273px] flex ">
                ...
                <div className="footer-part1 w-[33.3%] h-[273px] ">
                    <h5 className='font-[Montserrat] text-[20px] text-[#FFF] tracking-wide font-bold'>OUR CONTACTS</h5>
                    ...
                    <ul className='w-full h-[128px] flex flex-col mt-5 '>
                        ...
                        <div className="li-sub w-[225px] h-[48px] ml-2 text-[#FFFFFF]">
                            <div className="up-li">
                            <span>Weekdays:</span> <span className='ml-2'>08:00am - 08:00pm</span>
                            </div>

                            <div className="down-li">
                            <span>Weekends:</span> <span className='ml-2'>10:00am - 06:00pm</span>
                            </div>
                        </div>
                        </li>
                    </ul>
                ...
                <h5 className='font-[Montserrat] text-[20px] text-[#FFF] tracking-wide font-bold'>QUICK LINKS</h5>
                <div className="line w-[25%] h-[2.4px] mt-4 "></div>
                ...
                <h5 className='font-[Montserrat] text-[20px] text-[#FFF] tracking-wide font-bold'>GET IN TOUCH</h5>
                <div className="line w-[25%] h-[2.4px] mt-4 "></div>
                <p className='part3-text w-[375px] h-[48px]    mt-5'>We are always ready to help you solve any issue you may have with your vehicle.</p>
                <div className="part3-buttons w-[356px] h-[69px] flex  items-center mt-5">
                    ...
                    <a href="" className='text-white underline underline-offset-8 ml-4 decoration-2 duration-700 hover:text-[#1e52e8]'>VIEW ON MAP</a>
        ...
        <div className="footer-down w-full h-[138px] bg-[#2e2e2e] flex justify-center items-center">
            <div className="footer-down-container w-[80%] h-[78px] flex justify-center items-center ">
                <div className="down-part1 w-[33.3%] h-[78px] flex items-center ">
                    ...
                    <img className='w-[45px] h-[15px]'  src="https://livedemo00.template-help.com/wt_prod-25548/unit-car-repair/images/payment-1-45x15.png" alt="" />
                    <img className='w-[46px] h-[28px]' src="https://livedemo00.template-help.com/wt_prod-25548/unit-car-repair/images/payment-2-46x28.png" alt="" />
                    <img className='w-[62px] h-[17px]' src="https://livedemo00.template-help.com/wt_prod-25548/unit-car-repair/images/payment-3-62x17.png" alt="" />
                    </div>
                </div>
                <div className="down-part2 w-[33.3%] h-[78px]  flex justify-center items-center gap-3">
                
                <a className='footer-icon w-[32px] h-[32px] rounded-full border-solid border  flex justify-center items-center' href=""><FaFacebookF  /></a>
                <a className='footer-icon w-[32px] h-[32px] rounded-full border-solid border flex justify-center items-center' href=""><FaTwitter /></a>
                <a className='footer-icon w-[32px] h-[32px] rounded-full border-solid border flex justify-center items-center' href=""><TiSocialInstagram /></a>
                <a className='footer-icon w-[32px] h-[32px] rounded-full border-solid border flex justify-center items-center' href=""><IoLogoGoogleplus /></a>
